...
class Imagenet_Subset(object):
    def download_data(self):
        train_dir = os.path.join('/data/CL_data', 'imagenet100', 'train')
        test_dir = os.path.join('/data/CL_data', 'imagenet100', 'val')
