...
parser.add_argument('--task_num', default=25, type=int, help='the number of incremental steps')
...
def main():
    ...
    log_root = 'PRAKA/log/%s/phases_%d/seed_%d-%s-onlymix'%(args.data_name, args.task_num, args.seed, s)
